...
LocalizationData = 
{
	...
	CodexScripts =
	{
		...
		EntryText =
		{
			...
			LangItScaleModifier = 0.85,
			LangPlScaleModifier = 0.80,
	...
	GameStatsScreen =
	{
		...
		WeaponText = 
		{
			...
			LangPtBrScaleModifier = 1.0,
			LangPlScaleModifier = 0.73,
		},
		BoonText =
		{
			LangDeScaleModifier = 0.90,
			LangItScaleModifier = 0.90,
			LangPlScaleModifier = 0.67,
